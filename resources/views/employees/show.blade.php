					...
					<div class="col-xl-12">
						...
						<div class="card user-wideget user-wideget-widget widget-user">
							<div class="widget-user-header bg-primary">
								<h3 class="widget-user-username">Ahmad GH Nahal</h3>
								...
								<div class="row">
									<div class="col-sm-4 border-left">
										<div class="description-block">
											...
											<span class="description-text">الراتب</span>
										</div>
									</div>
									<div class="col-sm-4 border-left">
										<div class="description-block">
											<h5 class="description-header">ahmadnaha.12</h5>
											<span class="description-text">اسم المستخدم</span>
										</div>
									</div>
									<div class="col-sm-4">
										<div class="description-block">
											<h5 class="description-header">35</h5>
											<span class="description-text">عدد المشاركات</span>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-md-6">
						<div class="card mg-b-20">
							<div class="card-body">
								...
								<p class="mg-b-20">مخطط الانجاز اليومي</p>
