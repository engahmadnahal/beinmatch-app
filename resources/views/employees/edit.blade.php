...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">تعديل موظف</h2>
            </div>
        </div>
                    ...
                    <div class="card-body pb-0">
                        <div class="form-group">
                            ...
                            <select name="job_title" class="form-control nice-select custom-select" id="job_title"
                                style="display: none;">
                                <option>--تحديد--</option>
                                <option value="Admin" @if($emp->jop_title == 'Admin') selected @endif>Admin</option>
                                <option value="Writer" @if($emp->jop_title == 'Writer') selected @endif>Writer</option>
                            </select>
                            <br>
                            <br>

                            <label class="form-label">تفعيل</label>
                            <div class="active main-toggle main-toggle-secondary @if($emp->status == 'active') on @endif">
                                <input type="checkbox" name="status" id="status" style="display: none" @if($emp->status == 'active') checked @endif>
                                <span></span>
                            </div>
                        ...
                        <div class="row row-sm">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" placeholder="الايميل" name="email" id="email" value="{{$emp->email}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <select name="gender_emp" id="gender" class="form-control nice-select custom-select"
                                        ...
                                        <option value="M" @if($emp->gender == 'M') selected @endif>ذكر</option>
                                        <option value="F" @if($emp->gender == 'F') selected @endif>انثى</option>
                                    </select>
                                </div>
                            </div>
                        </div>
