...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">سياسة الاستخدام  </h2>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="wd-xl-100p ht-350">
                    <div class="ql-scrolling-demo bg-gray-100 ps" id="scrolling-container">
                        <input type="text" id="title" placeholder="شروط الاستخدام" style=" font-size: 25px; width: 100%; padding: 7px; outline: 0; background: transparent; border: 0; " value="{{$data->title}}">
...
<script src="{{asset('assets/plugins/fancyuploder/fancy-uploader.js')}}"></script>
    ...
    <script>
        function performStore() {
            ...
            axios.put('/term/{{$data->id}}', data).then(function(response) {
