...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">سياسة الخصوصية  </h2>
            </div>
        </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-3 col-md-12 mb-3 mb-md-0">
            ...
            <div class="card">
                ...
                <div class="py-2 px-3">
                    <button class="btn btn-primary-gradient mt-2 mb-2 pb-2" type="button" onclick="performStore()">نشر الأن</button>
                </div>
            </div>
            </form>
            ...
            <div class="card-body">
                ...
                <div class="wd-xl-100p ht-350">
                    <div class="ql-scrolling-demo bg-gray-100 ps" id="scrolling-container">
                        <input type="text" id="title" placeholder="سياسة الاستخدام" style=" font-size: 25px; width: 100%; padding: 7px; outline: 0; background: transparent; border: 0; " value="{{$data->title}}">
                        <textarea id="body" cols="30" rows="10" class="ql-container ql-bubble rtl" placeholder="أكتب الأن.." style="font-family: inherit; background: transparent; width: 100%; height: 100%; outline: 0;font-size: 19px; ">{{$data->body}}</textarea>
                    </div>
...
<script src="{{asset('assets/plugins/fancyuploder/fancy-uploader.js')}}"></script>
    ...
    <script>
        function performStore() {
            ...
            axios.put('/privacy/{{$data->id}}', data).then(function(response) {
