        ...
        <div class="col-xl-3 col-lg-3 col-md-12 mb-3 mb-md-0">
            <form id="post_form">
                <div class="card">
                    ...
                    <div class="py-2 px-3">
                        <button class="btn btn-primary-gradient mt-2 mb-2 pb-2" type="button" onclick="performStore()">حفظ
                            الأن</button>
                    </div>
                </div>
            </form>
                ...
                <div class="card-body">
                    ...
                    <div class="wd-xl-100p ht-350">
                        <div class="ql-scrolling-demo bg-gray-100 ps" id="scrolling-container">
                            <input type="text" name="post_title" id="post_title" placeholder="عنوان المقال"
                            ...
                            <textarea name="post_content" id="post_content" cols="30" rows="10" class="ql-container ql-bubble rtl"
                                placeholder="أكتب الأن.."
                                style="font-family: inherit; background: transparent; width: 100%; height: 100%; outline: 0;font-size: 19px; "></textarea>
                        </div>

                    </div>
                    <h3 style=" margin: 20px 0; ">صورة المقالة: </h3>
                    <input type="file" class="dropify" data-height="200" id="post_img" />
